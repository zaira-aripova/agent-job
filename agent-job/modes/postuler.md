...
5. **agent-job proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/agent-job contact` pour du LinkedIn outreach vers le hiring manager
